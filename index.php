...
Sundays always meant it's time to visit your cousin. 
</p>
<p>
...
<p>
Open Source Software, in contrast, is like the
...
<p>
In this world, the contact you'd make with your friends would be over an `IRC` 
( Internet Relay Chat ) where they'd ask you what you're doing and how to get 
started on it, and you'd redirect them to a `Repository` having whatever you've
done so far and give them advice on how to continue from there. 
</p>
<p>
Once they've made changes on their branch, they would send you a `pull request`
which you could then `merge` into your `Repo` if you feel you like it. Before 
you know it, you have the best collaborative effort!
</p>
<p>
...
<img alt="logo" src="img/osdg-hero.png" id="logo_right" />
